...
def _live_update_response_deserialize(live_update_states, bytes_response):
    ...
    if is_without_errors is True:
        ...
        if function_code == 1:
            _read_coils_live_update_deserialize(live_update_states, hex_response_array, deserialize_dict)
        elif function_code == 2:
            _read_discrete_inputs_live_update_deserialize(live_update_states, hex_response_array, deserialize_dict)
        elif function_code == 3:
            _read_holding_registers_live_update_deserialize(live_update_states, hex_response_array, deserialize_dict)
        elif function_code == 4:
            _read_input_registers_live_update_deserialize(live_update_states, hex_response_array, deserialize_dict)
...
def _read_holding_registers_live_update_deserialize(live_update_states, hex_response_array, deserialize_dict):
    modbus_response = hex_response_array[9:]
...
def _read_input_registers_live_update_deserialize(live_update_states, hex_response_array, deserialize_dict):
    modbus_response = hex_response_array[9:]
