...
from modbus_gui_app.logic.state import state_manager_data_structures
...
def init_live_update_states():
    current_coil_input_reg_states = state_manager_data_structures.init_live_update_states()
